...
// Επιστρέφει την τιμή στη θέση pos του set set (μη ορισμένο αποτέλεσμα αν pos < 0 ή pos >= size)

Pointer set_get_at(Set set, int pos);

// Αλλάζει την τιμή στη θέση pos του Set set σε value.
// ΔΕΝ μεταβάλλει το μέγεθος του set, αν pos >= size το αποτέλεσμα δεν είναι ορισμένο.
